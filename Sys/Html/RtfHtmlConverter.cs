...
namespace Itenso.Rtf.Converter.Html
{
  ...
  public class RtfHtmlConverter : RtfVisualVisitorBase
  {
    ...
    public RtfHtmlConverter( IRtfDocument rtfDocument, RtfHtmlConvertSettings settings )
    {
      ...
      _specialCharacters = new RtfHtmlSpecialCharCollection( settings.SpecialCharsRepresentation );
    } // RtfHtmlConverter
    ...
    public string Convert()
    {
      ...
      {
        using (_writer = XmlWriter.Create(stringWriter, new XmlWriterSettings() { OmitXmlDeclaration = true }))
        {
    ...
    protected override void DoVisitImage( IRtfVisualImage visualImage )
    {
      ...
      int imageIndex = _documentImages.Count + 1;
      string fileName = _settings.GetImageUrl( imageIndex, visualImage.Format );
      int width = _settings.ImageAdapter.CalcImageWidth( visualImage.Format, visualImage.Width,
        visualImage.DesiredWidth, visualImage.ScaleWidthPercent );
      int height = _settings.ImageAdapter.CalcImageHeight( visualImage.Format, visualImage.Height,
      ...
      _documentImages.Add( new RtfConvertedImageInfo(
        fileName,
        _settings.ImageAdapter.TargetFormat,
    ...
    protected override void DoVisitSpecial( IRtfVisualSpecialChar visualSpecialChar )
    {
      ...
      switch ( visualSpecialChar.CharKind )
      {
        ...
        default:
          ...
          {
            Writer.WriteRaw( SpecialCharacters[ visualSpecialChar.CharKind ] );
          }
          break;
      }
    ...
    // ----------------------------------------------------------------------
    // members
    private readonly RtfConvertedImageInfoCollection _documentImages = new RtfConvertedImageInfoCollection();
    ...
    private readonly RtfHtmlSpecialCharCollection _specialCharacters;
